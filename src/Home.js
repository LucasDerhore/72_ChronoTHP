...
const Home = (page = 1) => {
  ...
  const preparePage = () => {
    ...
    const fetchList = (url) => {
        ...
        .then((response) => {
          ...
          <div class="col-12 col-sm-4 flip-card border-success text-center">
            <div class="flip-card-inner">
              <div class="flip-card-front pic" style="background-image: url('${
              ...
              <div class="flip-card-back text-white text-center">
                <div class="game-info text-white">
                  ...
                  <h5 class="rating">${article.rating} / ${
              article.rating_top
            } - ${article.ratings_count} votes</h5>
      ...
      <a href = "#pagedetail/${
        article.id
      }" class="h3 text-white noHover link">${article.name}</a>
    </div> 
    `;
          });
    ...
    fetchList(
      `https://api.rawg.io/api/games?page_size=${
        page * 9
      }&dates=2022-01-22,2023-01-22&ordering=-added`
    );
  };
